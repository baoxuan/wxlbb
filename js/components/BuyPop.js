...
class BuyPop extends Component{
	...
	_submit(){
		let params = {goodsName:this.props.item.goodsName,barcode:this.props.item.barcode,joinNum:this.state.value, price: this.props.item.price, periodsNum:this.props.item.periodsNum}
